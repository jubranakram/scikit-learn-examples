...
if __name__ == '__main__':
    ...
    score_train = e_reg.score(X_train, y_train)
    score_test = e_reg.score(X_test, y_test)

    print(f"training score: {score_train}")
    print(f"testing score: {score_test}")
    print(f"number of features used: {np.sum(e_reg.coef_ !=0)}")
