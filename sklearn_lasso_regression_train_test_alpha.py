# -*- coding: utf-8 -*-
"""
about: lasso regression (train-test size)
...
if __name__ == '__main__':
    ...
    for idx in range(num_tests):
        ...
        for idx_1 in range(num_alpha):
            l_reg = Lasso(alpha=alpha[idx_1], max_iter=5000)
            ...
            score_train[idx, idx_1] = l_reg.score(X_train, y_train)
            score_test[idx, idx_1] = l_reg.score(X_test, y_test)
